...
{
	AI_Output (other, self, "DIA_Lothar_Regeln_15_00"); //Opowiedz mi o przepisach obowi¹zuj¹cych w mieœcie!
...
{
	AI_Output (other, self, "DIA_Lothar_PERM_15_00"); //Czy ostatnio wydarzy³o siê tu coœ niezwyk³ego?
	if (other.guild == GIL_NONE)
	|| (other.guild == GIL_SLD)
	{
