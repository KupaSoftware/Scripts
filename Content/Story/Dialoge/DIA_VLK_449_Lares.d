...
{
	AI_Output (other, self, "DIA_Addon_Lares_Ornament_15_00"); //Vatras wrêczy³ mi ten ornament, abym ci go przekaza³.
...
{
	AI_Output (other, self, "DIA_Lares_Paladine_15_00"); //Za wszelk¹ cenê muszê siê skontaktowaæ z paladynami!
...
{
	AI_Output (other, self, "DIA_Lares_WhyPalHere_15_00"); //Czy wiesz, dlaczego s¹ tu paladyni?
...
{
	AI_Output			(other, self, "DIA_Lares_KnowWhereEnemy_15_00"); //Masz mo¿e ochotê na opuszczenie wyspy?
