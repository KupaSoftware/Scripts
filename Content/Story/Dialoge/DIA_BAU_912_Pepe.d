...
{
	AI_Output (other, self, "DIA_Pepe_Hallo_15_00"); //Co tu porabiasz?
...
{
	AI_Output (other, self, "DIA_Pepe_Danger_15_00"); //A jakie¿ to niebezpieczeñstwa czyhaj¹ na pastwisku?
...
{
	AI_Output (other, self, "DIA_Pepe_WhyNotSLD_15_00"); //Dlaczego nie powiedzia³eœ o wilkach najemnikom?
...
{
	AI_Output (other, self, "DIA_Pepe_BullcoDefeated_15_00"); //Bullko dosta³ to, na co zas³ugiwa³.
