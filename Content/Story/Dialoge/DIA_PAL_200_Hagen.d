...
{
	AI_Output (other, self, "DIA_Hagen_PETZMASTER_PayNow_15_00"); //Chcê zap³aciæ grzywnê!
...
{	
	AI_Output (other,self ,"DIA_Lord_Hagen_KAP3U4_PERM_15_00"); //Jak wygl¹da sytuacja?
...
{	
	AI_Output (other,self ,"DIA_Lord_Hagen_AllDragonsDead_15_00"); //Wszystkie smoki nie ¿yj¹.
...
{	
	...
	AI_Output (other, self, "DIA_Lord_Hagen_Add_15_31"); //Wygl¹da na to, ¿e brama by³a otwart
