...
INSTANCE ItFo_MenelBeer (C_Item)
{	
	name 				=	"Piwo Constantina";
	...
	material 			=	MAT_GLAS;
	scemeName			=	"POTIONFAST";
	on_state[0]			=	Use_BeerMenel;

	description			= 	name;
	TEXT[2]				= 	"Eksperymentalne piwo Constantina";
	TEXT[3]				= 	"";
	TEXT[4]				= 	"Dzia³anie: nieznane";		
	TEXT[5]				= 	NAME_Value;		COUNT[5]	= Value_Beer;

};

FUNC VOID Use_BeerMenel()
	{											
			...
			B_LogEntry (TOPIC_ConstantinoBeer, "To piwo Constantina to trucizna, a nie lekarstwo! Muszê go jak najszybciej o tym powiadomiæ.");
			HeroKnowsInfoBeer = TRUE;
	};
	
INSTANCE ItFo_MenelBeer1 (C_Item)
{	
	name 				=	"Piwo Constantina";
